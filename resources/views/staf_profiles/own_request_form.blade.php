...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark text-weight-bold">My Requests</h1>
                </div>
                <div class="col-sm-6">
    ...
    <div class="content">
        ...
        <div class="bg-white card-primary card-maroon">
            ...
            <div class="card-body table-responsive">
                <form class="requires-validation" method="post" action="{{ route('own_requests.store') }}">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <a href="{{ route('own_requests.index') }}" class="btn btn-outline-danger btn-flat btn-lg text-maroon">Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>
