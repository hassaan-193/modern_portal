...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">New Vendor Payable</h1>
            </div>
            <div class="col-sm-6">
        ...
        <div class="col-md-9">
            <div class="card card-primary card-maroon">
                <div class="card-header">
                    <h3 class="card-title">Payable Details</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('vendor-payables.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="project_id" id="project_id"
                                    ...
                                    @foreach($projects as $id => $subject)
                                        <option value="{{ $id }}" {{ old('project_id') == $id ? 'selected' : '' }}>{{ $subject }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="due_date" id="due_date"
                                        ...
                                        value="{{ old('due_date') }}" placeholder="YYYY-MM-DD" autocomplete="off">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="reference_no"
                                    ...
                                    value="{{ old('reference_no') }}" placeholder="e.g. INV-2026-001">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="source_reference"
                                    ...
                                    placeholder="e.g. Email from Finance 18 Jun 2026, Payment Schedule Q2">
                                <small class="form-text text-muted">Where this obligation originated — file name, email, spreadsheet row, etc.</small>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="note" rows="3"
                                    ...
                                    placeholder="Any additional context about this obligation...">{{ old('note') }}</textarea>
                            ...
                            <div class="form-group col-12 mt-2">
                                <button type="submit" class="btn btn-danger btn-lg btn-flat">
                                    <i class="fa fa-save"></i> Create Payable
                                </button>
                                <a href="{{ route('vendor-payables.index') }}" class="btn btn-outline-secondary btn-lg btn-flat ml-2">
                                    Cancel
                                </a>
                            </div>
                        </div>
