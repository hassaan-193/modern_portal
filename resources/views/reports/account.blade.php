...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark text-weight-bold">@lang('models/reports.account.title')</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                        <li class="breadcrumb-item active">@lang('models/reports.account.title')</li>
                    </ol>
                </div>
            </div>
        </div>
  ...
  <div class="content">
    ...
    <div class="bg-white card-primary card-maroon">
        <div class="card-header">
            <h3 class="card-title">@lang('models/reports.account.title')</h3>
        </div>
    ...
    <script>
        $(window).on('load', function() {
            ...
            accounts.forEach((account,key) => {
                options[key] = '<option value='+account.id+'>'+account.type+' '+account.code+'</option>';
            });
            ...
            $("div.table-filter").html(`
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="filter-group">
                            <select class="form-control" id="name" onchange="setAccount()" name="name">
                                <option></option>
                                ${
                                    options
                                }
