...
class StaffRequestDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'staf_profiles.requests_datatables_actions')
    ...
    {
        $model = $model->newQuery()->with('staf');
    ...
    protected function getColumns()
    {
        return [
            ...
            'name' => new Column(['title' => __('models/labor_requests.fields.name'), 'data' => 'staf.name', 'searchable' => false]),
