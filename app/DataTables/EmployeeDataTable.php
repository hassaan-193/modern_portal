...
class EmployeeDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            'code' => new Column(['title' => __('models/employees.fields.code'), 'data' => 'code']),
            'email' => new Column(['title' => __('models/employees.fields.email'), 'data' => 'email']),
            'contact_no' => new Column(['title' => __('models/employees.fields.contact_no'), 'data' => 'contact_no']),
            'balance' => new Column(['title' => __('models/employees.fields.balance'), 'data' => 'balance','searchable' => false])
        ];
    }
