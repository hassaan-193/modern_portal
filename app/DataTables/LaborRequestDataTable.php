...
class LaborRequestDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'labor_requests.datatables_actions')
     ...
     *
     * @param \App\Models\LaborRequest $model
     * @return \Illuminate\Database\Collection\Builder
     */
    public function query(LaborRequest $model)
    {
        $model = $model->newQuery()->with('labor');
    ...
    protected function getColumns()
    {
        return [
            ...
            'labor_name' => new Column(['title' => __('models/labor_requests.fields.name'), 'data' => 'labor.name', 'searchable' => false]),
